	...
	$.Gallery.prototype 	= {
		...
		_layout				: function() {
			...
			if( this.support3d && this.supportTrans ) {
				...
				leftCSS 	= {
					'-webkit-transform'	: 'translateX(-56%) translateZ(-65px)',
					'-moz-transform'	: 'translateX(-56%) translateZ(-65px)',
				...
				leftCSS 	= {
					'-webkit-transform'	: 'translate(-56%) scale(0.8)',
		...
		_getCoordinates		: function( position ) {
			...
			if( this.support3d && this.supportTrans ) {
				...
				switch( position ) {
					case 'outleft':
						return {
							'-webkit-transform'	: 'translate(-56%) scale(0.7)',
							'-moz-transform'	: 'translate(-56%) scale(0.7)',
							'-o-transform'		: 'translate(-56%) scale(0.7)',
